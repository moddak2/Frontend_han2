  ...
  return (
    <main className="site-shell">
      <header className="site-header">
        ...
        <div className="header-status"><span className="status-dot" /> 보안 시스템 정상 작동 중</div>
      </header>
          ...
          <div className="phone-wrap">
            <div className="phone" aria-live="polite">
              ...
              <div className="phone-screen">
                ...
                {current.key === 'dashboard' && <DashboardScreen />}
              </div>
...
function DashboardScreen() {
  return <div className="screen app-screen"><div className="app-title"><h3>보안 대시보드</h3><button>이번 주⌄</button></div><div className="safe-card"><span className="safe-icon"><Icon name="check" /></span><div><strong>오늘 안전 상태: <em>안전</em></strong><small>위험 상황이 발견되지 않았어요</small></div><span>›</span></div><div className="analysis-card"><span>오늘 분석 <strong>24건</strong></span><ul><li className="warn">△ <span>주의</span><b>2건</b></li><li className="danger">△ <span>경고/차단</span><b>1건</b></li><li>♙ <span>보호자 알림</span><b>0건</b></li></ul></div><div className="activity-card"><strong>최근 활동</strong><ul><li><time>14:30</time><span>안전한 입력 감지</span></li><li><time>13:21</time><span>주의: 금융정보 입력</span></li><li><time>11:05</time><span>안전한 입력 감지</span></li></ul></div><PhoneNav active="home" /></div>;
}
